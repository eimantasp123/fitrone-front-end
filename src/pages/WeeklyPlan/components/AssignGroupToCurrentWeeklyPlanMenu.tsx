...
interface AssignGroupToCurrentWeeklyPlanMenuProps {
  isOpen: boolean;
  onClose: () => void;
  loading: boolean;
...
/**
 *  Modal to assign group to the current weekly plan menu
 */
const AssignGroupToCurrentWeeklyPlanMenu: React.FC<
  AssignGroupToCurrentWeeklyPlanMenuProps
...
export default AssignGroupToCurrentWeeklyPlanMenu;
