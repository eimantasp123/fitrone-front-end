...
interface WeekPlanCarouselForHeaderProps {
  goBack: boolean;
  currentWeekPlan: string[];
}

const WeekPlanCarouselForHeader: React.FC<WeekPlanCarouselForHeaderProps> = ({
  goBack,
  currentWeekPlan,
}) => {
...
export default WeekPlanCarouselForHeader;
