...
export default function ClientHeader() {
  ...
  return (
    <header className="flex min-h-20 px-2 md:px-8 border-b-[1px] md:bg-background md:dark:bg-backgroundDark border-gray-200 md:justify-between items-center gap-10">
      {/* Welcome Text */}
      <div className="w-[20%] hidden whitespace-nowrap dark:text-white md:block min-h-[40px]">
      ...
      <div className="flex items-center gap-5">
        ...
        <Menu isOpen={isNotificationsOpen} onClose={onNotificationsClose}>
          ...
          >
            <IconButton icon={<IoIosNotificationsOutline className="text-xl dark:text-text1" />} variant="ghost" />
            <Badge
              variant="solid"
              colorScheme="red"
              position="absolute"
        ...
        <NavLink to="/help" className="text-sm hidden cursor-pointer lg:flex items-center gap-2">
          <span className="text-base dark:text-text1 align-middle">
            <BiSupport />
          </span>
          <h2 className="whitespace-nowrap dark:text-text1 select-none">Help Center</h2>
        </NavLink>
