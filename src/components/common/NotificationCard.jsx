...
export default function NotificationCard({
  ...
  return (
    ...
    >
      <div className="w-[90%]">
        <h6 className="font-medium leading-snug text-textPrimary">
      ...
      {notification.read ? (
        <IoNotificationsOffCircle className="w-[10%] text-3xl text-neutral-500" />
      ) : (
        <IoNotificationsCircleSharp className="w-[10%] text-3xl text-primaryDark" />
      )}
      <span
