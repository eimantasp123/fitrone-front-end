...
> = ({ title, description }) => {
  return (
    <div className="mt-4 flex h-full w-full flex-col items-center justify-center rounded-lg bg-backgroundSecondary px-8 py-16 text-center dark:bg-background">
